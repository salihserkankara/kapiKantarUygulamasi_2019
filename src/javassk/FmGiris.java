...
public class FmGiris extends javax.swing.JFrame {
    ...
    public FmGiris(String adsoyad,FmHome home) {
        initComponents();
        fmhome3=home;
        try
        {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Ağırlık");

        jButton4.setText("Kayıt");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        double sayi;
        boolean sayigiriniz=false;
        try{
                 sayi = Double.valueOf(jTextField3.getText().trim());   
        ...
        if(!sayigiriniz){
            try{
            stateSQL.execute("INSERT INTO giriscikis (plaka, sofor , girisagirligi, giristarihi, kayiteden) VALUES ('"+jTextField1.getText().trim()+"','"+jTextField2.getText().trim()+"',"+jTextField3.getText().trim()+",'"+localdate.format(DateTimeFormatter.ofPattern("yyyy.MM.dd"))+"', '"+adsoyadFm+"')");
            ...
            JOptionPane.showMessageDialog(this,"Kayıt Başarısız.. Hata:"+ex.getMessage());
        }   
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FmGiris("",null).setVisible(true);
            }
        });
    }
